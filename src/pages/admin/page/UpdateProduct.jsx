            ...
            <div className=' flex justify-center items-center h-screen'>
                <div className=' bg-gray-800 px-10 py-10 rounded-xl '>
                    ...
                    <div>
                        <input type="text"
                            value={products.ram}
                            onChange={(e) => setProducts({ ...products, ram: e.target.value })}
                            name='ram'
                            className=' bg-gray-600 mb-4 px-2 py-2 w-full lg:w-[20em] rounded-lg text-white placeholder:text-gray-200 outline-none'
                            placeholder='ram'
                        />
                    ...
                    <div>
                        <input type="text"
                            value={products.rom}
                            onChange={(e) => setProducts({ ...products, rom: e.target.value })}
                            name='category'
                            className=' bg-gray-600 mb-4 px-2 py-2 w-full lg:w-[20em] rounded-lg text-white placeholder:text-gray-200 outline-none'
                            placeholder='rom'
                        />
                    ...
                    <div>
                        <input
                            type="number"
                            value={products.quantity} // Use products.quantity for the value
